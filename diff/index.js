var ActionNode = /** @class */ (function () {
    function ActionNode(action, value, idx) {
        this.action = "";
        this.value = "";
        this.index = 0;
        this.action = action;
    ...
    ActionNode.prototype.getDesc = function () {
        var s = this.index + ": " + this.action + " " + this.value + "\n";
...
var Diff = /** @class */ (function () {
    ...
    Diff.prototype.check = function () {
        var sourceCount = src.length;
        var destCount = dest.length;
        var srcArray = this.src.split("");
        var destArray = this.dest.split("");
        // 记录操作，方便回溯
        ...
        out: for (var d = 1; d < sourceCount + destCount; d++) {
            ...
            for (var k = d; k >= -d; k -= 2) {
                ...
                while (y < destCount && x < sourceCount && srcArray[x] == destArray[y]) {
                    var ac = new ActionNode(" ", destArray[y], lastAction.index + 1);
                    x += 1;
                    y += 1;
